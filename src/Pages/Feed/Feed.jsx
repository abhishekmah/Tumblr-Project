...
const data = [
    ...
    },
    {
        ...
        userId: {
            ...
            avatarUrl:
                'https://64.media.tumblr.com/d4492eaba605defbde742516808f5115/5380e3da7cfa939c-52/s64x64u_c1/d6d2750be16811526c81ef0623b5b536ed2f2d09.pnj',
        },
    },
    {
        title: 'AbhishekBlog',
                ...
                <div className={styles.left}>
                    ...
                    {data.map((el) => (
                        <div className={styles.blog}>
                            ...
                            <p>
                                {el.userId.userName}
                                <span className={styles.cont2_infoF1}>
                                    Follow
                                </span>
                            </p>
                            {el.image.map((i) => (
